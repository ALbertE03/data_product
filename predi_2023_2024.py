...
print(predict2)
aaa2=list(p)+list(predict2)
plt.plot(annos,productos_agropecuarios,'.')
plt.plot([x for x in range(1989,2025)],aaa2)
plt.show()
...
print(predict3)
aaa3=list(p)+list(predict3)
plt.plot(annos,productos_azucar,'.')
plt.plot([x for x in range(1989,2025)],aaa3)
plt.show()
...
print(predict4)
aaa4=list(p)+list(predict4)
plt.plot(annos,productos_mineria,'.')
plt.plot([x for x in range(1989,2025)],aaa4)
plt.show()
...
print(predict5)
aaa5=list(p)+list(predict5)
plt.plot(annos,productos_tabaco,'.')
plt.plot([x for x in range(1989,2025)],aaa5)
plt.show()
...
actual = {'Productos agropecuarios':agrego[1],
    'Productos de la Pesca':agrego[0],
    
    'Productos de la industria azucarera':agrego[2],
    'Productos de la minería':agrego[3],
    'Productos de la industria del tabaco':agrego[4]

}
actual_df = pd.DataFrame(actual)
actual_df.to_json("data/predi.json",indent=4)
