...
fig = px.line(
    pesca_pib_const.T, title="Evolución del pib de la pesca a precios constantes"
)
...
def auto1(año, df):
    ...
    fig.update_layout(
        title=f"PIB a precios constantes: {año}", yaxis_title="Millones de pesos"
    )
